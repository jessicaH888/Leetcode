...
class Solution {
    public int wiggleMaxLength(int[] nums) {
        ...
        //up[i] means the max length when it ends with ith element and ith element is larger than previous one
        //down[i] means the max length when it ends with ith element and ith element is smaller than previous one
